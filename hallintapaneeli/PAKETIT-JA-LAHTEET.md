...
| Google Calendar | Virallinen Events.list tukee tapahtumahakua; OAuth tarvitaan yksityiseen perhekalenteriin. OAuth-ohje ja käytännön redirect/token-asetukset tarkistetaan toteutuksessa. | [Events.list](https://developers.google.com/workspace/calendar/api/v3/reference/events/list) · [OAuth](https://developers.google.com/identity/protocols/oauth2/web-server) |
