...
return [
    ...
    'attributes' => [
        ...
        'active' => 'näkyvyys',
        'place' => 'paikkakunta',
        'price_basis' => 'näytettävä hinta',
        'green_below' => 'vihreä raja',
        'red_from' => 'punainen raja',
        'message_green' => 'vihreä ohje',
        'message_yellow' => 'keltainen ohje',
        'message_red' => 'punainen ohje',
        'message_red_extra' => 'punaisen lisärivi',
        'message_unknown' => 'puuttuvan hinnan teksti',
        'code' => 'koodi',
        'name' => 'nimi',
        'title' => 'otsikko',
        'description' => 'kuvaus',
        ...
        'due_time' => 'kellonaika',
        'reward_eur' => 'korvaus',
        'ical_url' => 'iCal-osoite',
        'api_key' => 'rajapinta-avain',
        'calendar_id' => 'kalenterin tunnus',
        'calendars' => 'kalenterit',
        'pattern' => 'poissaolon tapa',
        'starts_on' => 'alkamispäivä',
        'ends_on' => 'päättymispäivä',
        'member_ids' => 'tekijät',
        'show_private_titles' => 'yksityisten otsikot',
        'show_location' => 'paikka',
    ],
];
